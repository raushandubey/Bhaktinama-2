        ...
        <form action="{{ route('admin.pandits.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="phone" name="phone" placeholder="Enter phone number" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-500">
                </div>

                <div>
                    <label for="email" class="block text-sm font-medium text-gray-700 mb-2">Email Address</label>
                    <input type="email" id="email" name="email" placeholder="Enter email address" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-500">
                </div>

                <div>
                    <label for="experience" class="block text-sm font-medium text-gray-700 mb-2">Years of Experience</label>
                    <input type="number" id="experience" name="experience" placeholder="Enter years of experience" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-500">
                </div>

                <div class="md:col-span-2">
                    <label for="description" class="block text-sm font-medium text-gray-700 mb-2">Description</label>
                    <textarea id="description" name="description" rows="4" placeholder="Enter the description" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-500"></textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                        <div class="flex items-center">
                            <input type="checkbox" id="service_1" name="services[]" value="Griha Pravesh" class="h-4 w-4 text-orange-500 border-gray-300 rounded focus:ring-orange-500">
                            <label for="service_1" class="ml-2 text-sm text-gray-700">Griha Pravesh</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="service_2" name="services[]" value="Satyanarayan Puja" class="h-4 w-4 text-orange-500 border-gray-300 rounded focus:ring-orange-500">
                            <label for="service_2" class="ml-2 text-sm text-gray-700">Satyanarayan Puja</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="service_3" name="services[]" value="Vastu Shanti" class="h-4 w-4 text-orange-500 border-gray-300 rounded focus:ring-orange-500">
                            <label for="service_3" class="ml-2 text-sm text-gray-700">Vastu Shanti</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="service_4" name="services[]" value="Ganesh Puja" class="h-4 w-4 text-orange-500 border-gray-300 rounded focus:ring-orange-500">
                            <label for="service_4" class="ml-2 text-sm text-gray-700">Ganesh Puja</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="service_5" name="services[]" value="Kaal Sarp Dosh Nivaran" class="h-4 w-4 text-orange-500 border-gray-300 rounded focus:ring-orange-500">
                            <label for="service_5" class="ml-2 text-sm text-gray-700">Kaal Sarp Dosh Nivaran</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="service_6" name="services[]" value="Navgraha Shanti" class="h-4 w-4 text-orange-500 border-gray-300 rounded focus:ring-orange-500">
