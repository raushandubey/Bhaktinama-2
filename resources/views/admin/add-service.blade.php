    ...
    <div class="max-w-4xl mx-auto">
        ...
        <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="service_type" name="service_type" 
                        ...
                        <option value="ceremony" {{ old('service_type') == 'ceremony' ? 'selected' : '' }}>Ceremony</option>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="introduction" name="introduction" rows="4" 
                              placeholder="Enter the Introduction About service" 
                ...
                <div class="md:col-span-2">
                    <label for="importance" class="block text-sm font-medium text-gray-700 mb-2">Importance of Service</label>
                    <textarea id="importance" name="importance" rows="4" 
                              placeholder="Enter the Importance of service" 
                ...
                <div class="md:col-span-2">
                    <label for="traditions" class="block text-sm font-medium text-gray-700 mb-2">Traditions & Cultural Significance</label>
                    <textarea id="traditions" name="traditions" rows="4" 
                              placeholder="Enter Traditions & Cultural Significance" 
                ...
                <div class="md:col-span-2">
                    ...
                    <div id="packages-container">
                        <div class="package-row flex gap-4 mb-3">
                            ...
                            <div class="flex-1">
                                <input type="number" name="packages[0][price]" placeholder="Enter the Amount" step="0.01" 
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500">
                            </div>
                        </div>
                    </div>
                    <button type="button" id="add-package" class="text-orange-500 text-sm font-medium hover:text-orange-600">
                        + Add package
                    </button>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <button type="button" id="add-faq" class="text-orange-500 text-sm font-medium hover:text-orange-600">
                        + Add FAQ
                    </button>
                </div>
            ...
            <div class="flex justify-center mt-8">
                <button type="submit" class="px-8 py-3 bg-blue-900 text-white rounded-md hover:bg-blue-800 font-medium">
                    Add Service
                </button>
            </div>
        </form>
